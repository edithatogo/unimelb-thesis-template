...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.5\textwidth]{unimelb_logo.eps} % Assumes unimelb_logo.eps is in the Figures/ directory
    \caption{Example of a single figure (University of Melbourne Logo).}
    \label{fig:unimelb_logo_example}
\end{figure}

Figure \fref{fig:unimelb_logo_example} shows a simple figure. For more complex layouts, subfigures can be used, as shown in Figure \fref{fig:subfigures_example}.
...
\begin{table}[htbp]
    ...
    \begin{tabular}{@{}llr@{}} % @{} removes extra space at the ends
        \toprule
